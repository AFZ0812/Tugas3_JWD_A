...
// perintah sql untuk insert data
      $sql = "INSERT INTO daftar_pesanan(id_paket_wisata, nama_pemesan, no_tlp, tanggal_pemesanan, jumlah_peserta, 
                jumlah_hari, akomodasi, transportasi, makanan, 
                harga_paket, total_tagihan) 

              VALUES('$id_paket_wisata', '$nama_pemesan', '$no_tlp', '$tgl_pesan', 
